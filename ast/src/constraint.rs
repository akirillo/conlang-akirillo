...
/// The [`Constraint`] data type represents a constraint.
/// A constraint is composed of three linear combinations.
/// A constraint has the form: `A * B = C` where `A`, `B`, and `C` are linear combinations.
